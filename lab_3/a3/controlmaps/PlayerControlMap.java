...
import a3.controlmaps.controlactions.Button_2Action;
import a3.controlmaps.controlactions.GameWorldAssetAction;
import a3.controlmaps.controlactions.LeftStickPressAction;
import a3.controlmaps.controlactions.LeftStickYAction;
import a3.controlmaps.controlactions.MouseAction;
import a3.controlmaps.controlactions.OverheadAction;
import a3.controlmaps.controlactions.RightStickXAction;
import a3.controlmaps.controlactions.RightStickYAction;
import tage.input.*;
...
public class PlayerControlMap {
	...
	private void initializeMouseControls() {
		...
		// inputManager.getMouseController(),
		// net.java.games.input.Component.Identifier.Button.,
		// mouseAction, InputManager.INPUT_ACTION_TYPE.ON_PRESS_ONLY);
	}
