...
public class GameObject {
	...
	private float anglePerSecond = 5f;
	...
	/** adds the current elapsed time to the GameObject's internal clock */
	public void addTime(float t) {
		time += t;
	}

	/** returns the current time of the GameObject's internal clock */
	public float getTime() {
		return time;
	}

	/** sets the current time of the GameObject's internal clock */
