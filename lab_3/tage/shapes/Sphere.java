...
/**
 * Sphere is described in Chapter 6 of Computer Graphics Programming in OpenGL
 * with Java.
 ...
 * Texturing expects an image that has been pre-distorted at the poles (such as
 * typical planetary textures).
...
public class Sphere extends ObjShape {
	...
	/**
	 * precision is the number of vertices per slice, and the number of slices.
	 * Total number of vertices is precision*precision.
	 */
	...
	protected Vector3f[] getTangentsVector() {
		return tangents;
	}
}